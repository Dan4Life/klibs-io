...
VALUES (48101, 'app.cash.zipline', 'qualifies', '1.0.0'),
       ...
       (48111, 'io.github.suspect', 'lone', '1.0.0'),
...
VALUES (48101, 48001, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'app.cash.zipline', 'qualifies', '1.0.0', NULL, NULL, 'gradle', '8.0',
       ...
       (48111, 48001, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'io.github.suspect', 'lone', '1.0.0', NULL, NULL, 'gradle', '8.0',
        '2.0.0', '[]'::jsonb, NULL, '[]'::jsonb, 'SEARCH_MAVEN', 48111),
...
VALUES (48001, 'qualifies', 'io.github.suspect', 'PENDING', NULL, CURRENT_TIMESTAMP),
       ...
       (48001, 'lone', 'io.github.suspect', 'PENDING', NULL, CURRENT_TIMESTAMP),
